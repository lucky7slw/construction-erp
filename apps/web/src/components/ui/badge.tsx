  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        construction:
          'border-transparent bg-construction-100 text-construction-800 hover:bg-construction-200 dark:bg-construction-900 dark:text-construction-300',
        safety:
          'border-transparent bg-safety-100 text-safety-800 hover:bg-safety-200 dark:bg-safety-900 dark:text-safety-300',
      },
    },
    defaultVariants: {
      variant: 'default',
